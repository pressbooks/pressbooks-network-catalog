<form action="/catalog" method="get">
    <div class="search-box">
        <div class="search">
            ...
            <input x-data type="search" name="search" placeholder="{{ __('Find a book', 'pressbooks-network-catalog') }}" aria-labelledby="search-input-label" x-model="$store.filters.search"/>
